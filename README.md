...
|:---:|:------------|:----------------|:------------------------------|:----:|
| 1   | 监督学习     | [线性回归](1.线性回归/理论.md)         | 损失函数、最小二乘、梯度下降   | ✅   |
| 2   | 监督学习     | [逻辑回归](2.逻辑回归/理论.md)         | Sigmoid、分类阈值              | ✅   |
| 3   | 监督学习     | [K近邻（KNN）](3.K近邻（KNN）/理论.md)     | 距离度量、k值选择               |✅   |
| 4   | 监督学习     | [支持向量机（SVM）](4.支持向量机（SVM）/理论.md)| 超平面、间隔、核函数            | ✅   |
